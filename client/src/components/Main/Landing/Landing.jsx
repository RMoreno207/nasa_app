...
function Landing() {
  ...
  //Texto cabecera
  const text = `This comprehensive data set from The Meteoritical Society contains information on all of the known meteorite landings. The Fusion Table is collected by Javier de la Torre and we've also provided an XLS file that consists of 34,513 meteorites and includes the following fields:
      ...
      <div>
        ...
        <div className="mx-4">
          <div className="flex justify-center">
            <button
              className="button1 bg-black mx-1 ml-4 rounded p-3 m-4"
              type="submit"
              onClick={handleMass}
            >
              Search
            </button>
            <label htmlFor="searchMass" className="mx-2 my-auto">
              by mass
            </label>
            <input
              className="text-black rounded w-32 my-auto mx-2"
              type="text"
              name="byMass"
              ref={byMass}
              placeholder="2900"
          ...
          <div className="flex justify-center">
            ...
            <label htmlFor="searchClass" className="mx-2 my-auto">
              by class
            </label>
            <input
              className="text-black rounded w-32 my-auto mx-2"
              ...
              >
                <Popup>
                  <ul>
                    <li>
                      Name:{" "}
                      <Link to={`/landing/detail/${data.id}`}>{data.name}</Link>
                    </li>
                    <li>ID: {data.id}</li>
